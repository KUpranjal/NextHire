...
const Footer = () => {
  return (
    <footer className="mt-16 border-t border-white/40 bg-slate-950 text-slate-200 py-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            <h2 className="text-2xl font-bold text-white">Job Hunt</h2>
            <p className="text-sm text-slate-400">© 2026 Job Hunt. Crafted for ambitious careers.</p>
          </div>

          <div className="flex space-x-4">
            <a href="https://facebook.com" className="hover:text-orange-400 transition-colors" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-orange-400 transition-colors" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-orange-400 transition-colors" aria-label="LinkedIn">
